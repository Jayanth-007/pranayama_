...
class _BhramariBreathingPageState extends State<BhramariBreathingPage> {
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            _buildBeginButton(),
            SizedBox(height: 32),
            _buildSectionTitle("About Bhramari Breathing"),
        ...
        child: TextButton(
          onPressed: () {
            Navigator.push(
              context,
              MaterialPageRoute(
                builder: (context) => BhramariBreathingLearnMorePage(),
              ),
            );
          },
          child: Text(
            ...
            child: ElevatedButton(
              ...
              child: Column(
                children: [
                  ...
                  if (entry.key == '5:8') SizedBox(height: 4),
                  if (entry.key == '5:8')
                    Text(
                      'Recommended',
                      style: TextStyle(
  ...
  Widget _buildDurationHint() {
    final inhale = _selectedTechnique == '5:8' ? 5 : 4;
    final exhale = _selectedTechnique == '5:8' ? 8 : 6;
    ...
    return OutlinedButton.icon(
      ...
      onPressed: () async {
        final result = await showCustomizationDialog(
          context,
          initialInhale: _selectedTechnique == '5:8' ? 5 : 4,
          initialExhale: _selectedTechnique == '5:8' ? 8 : 6,
          initialHold: 0,
        );
  ...
  List<Widget> _buildInstructionSteps() {
    return [
      _buildStepCard(1, "Sit comfortably with your spine straight and relax your shoulders."),
      _buildStepCard(2, "Place one hand on your chest, one on your abdomen."),
      _buildStepCard(3, "Inhale deeply through your nose for 5 seconds, feeling your stomach rise."),
      _buildStepCard(4, "Exhale slowly while making a humming sound for 8 seconds."),
