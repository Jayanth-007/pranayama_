...
class _ChandraBhedanaPranayamaPageState extends State<ChandraBhedanaPranayamaPage> {
  ...
  final List<String> _breathingTechniques = [
    '4:4 Chandra Bhedana Pranayama (Standard)',
    'Customize Technique',
  ];

  // Hardcoded YouTube video URL for Chandra Bhedana demonstration.
  ...
  void _navigateToTechnique() {
    ...
    switch (_selectedTechnique) {
      case '4:4 Chandra Bhedana Pranayama (Standard)':
        Navigator.push(
          context,
          MaterialPageRoute(
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            Text("What is Chandra Bhedana Pranayama?", style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold)),
            SizedBox(height: 4.0),
            Text(
              "Chandra Bhedana Pranayama involves inhaling through the left nostril and exhaling through the right. This practice is believed to calm the mind, cool the body, and balance lunar energy.",
            ...
            Card(
              ...
              child: ListTile(
                ...
                title: Text("Sit comfortably with an upright posture and relax your shoulders."),
              ),
            ),
            Card(
              margin: const EdgeInsets.symmetric(vertical: 8.0, horizontal: 4.0),
              ...
              child: ListTile(
                ...
                title: Text("Close your right nostril gently with your finger and inhale slowly through your left nostril."),
              ),
            ),
            Card(
              margin: const EdgeInsets.symmetric(vertical: 8.0, horizontal: 4.0),
              ...
              child: ListTile(
                ...
                title: Text("Close your left nostril and exhale slowly through your right nostril."),
              ),
            ),
            Card(
              margin: const EdgeInsets.symmetric(vertical: 8.0, horizontal: 4.0),
              ...
              child: ListTile(
                ...
                title: Text("Repeat the cycle, focusing on the calming lunar energy with each breath."),
              ),
            ),
          ],
        ),
      ...
      bottomNavigationBar: Padding(
        ...
        child: Row(
          ...
          children: [
            ...
            ElevatedButton(
              onPressed: () {
                // Replace with your actual Learn More page for Chandra Bhedana.
                Navigator.push(context, MaterialPageRoute(builder: (context) => ChandraBhedanaPranayamaLearnMorePage()));
              },
